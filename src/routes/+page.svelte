<article>
    ...
    <section>
        <p>
            ...
            <br>
            Het stuk opent met een jammerklacht van Maria. Ze is sinds een aantal jaren blind – <cite>Het zij de zon verrijst, of hare stralen dooft / In ’t wester pekelveld, mij is ’t geheel omtëven</cite> – en gaat gebukt onder ‘bittere arremoede’. Maar oneindig veel zwaarder dan de blindheid en armoede bedrukt haar de ‘ondragelijke smert’ haar zoon Bernard, haar eerstgeborene, te moeten missen, die ze vreest nooit meer levend terug te zullen zien. Er wordt verteld dat hij al omgekomen zou zijn.
        </p>
        <blockquote>
...
Behaagt mij veel meer, dan het stormvol pekelnat.
        ...
        <p>
            Hoe het afloopt met Bernard Bade is, behalve in het toneelstuk zelf, te lezen in het <cite>Zedekundig leesboek, in den vorm van geschiedenissen ten dienst van scholen</cite>, uitgegeven door de Maatschappij tot nut van ’t algemeen (8e druk 1829), waarin als voorbeeld voor de jeugd een hoofdstuk aan hem is gewijd. Omdat het te mooi is om te verminken, volgt hier de hele, uit twee delen plus vragen bestaande tekst.
        </p>
        <blockquote>
...
Wat leert ons zijne blijmoedigheid in zijn ongeluk?
    ...
    <section>
        <p>
            ...
            <br>
            Met Bloems <cite>Verzamelde gedichten</cite> onder mijn arm liep ik naar de IJssel, die ver buiten zijn oevers stond. Ik sloeg het boek open op een willekeurige plaats en las: “De zon brak door de barre voorjaarslucht. Plotseling kantelde er een vogelvlucht. Op de aarde smolt de dungezaaide sneeuw. Hart, gij zijt vrij, gij waart om niets beducht.”
        </p>
        <p>
    ...
    <section>
        <p>
            ...
            <br>
            Maerlant voltooide zijn <cite>Rijmbijbel</cite> in 1271. Bijna een eeuw lang was dit het enige boek waarin mensen die geen Latijn kenden de geschiedenis van het Oude Testament in het Nederlands konden lezen. Het handschrift is in de veertiende eeuw in bezit geweest van de familie Van Zuylichem, zoals blijkt uit later bijgeschreven aantekeningen in de kalender, waarin het overlijden van leden van deze familie wordt vermeld. In de negentiende eeuw was het in bezit van de dichter <writer name="staring" data-writer="staring">Staring</writer> te Zutphen, na wiens dood het terecht kwam bij zijn vriend <writer name="lulofs" data-writer="lulofs">Lulofs</writer> in Groningen, die het in 1849 aan de Universiteitsbibliotheek naliet. Sindsdien staat het boek bekend als het Zutphens-Groningse of Gronings-Zutphense Maerlanthandschrift.
        </p>
    </section>
