<article>
    ...
    <section>
        <p>
            <img src="/images/janus_secundus.jpg" alt="Janus Secundus" class="float-left image-lines-8">
...
’k bezing uw tranen graag, ’k zal u vanzelf verkiezen
    ...
    <section>
        <p>
            <img src="/images/zutphens_liedboek-2.webp" alt="Zutphens Liedboek" class="float-left image-lines-12">
...
ich hap, datt sie mien boelkenn
    ...
    <section>
        <p>
            <img src="/images/sir_philip_sidney-standbeeld.jpg" alt="Sir Philip Sidney in Sidneypark" class="float-left image-lines-10">
    ...
    <section>
        <p>
            <img src="/images/guilliam_de_bay.jpg" alt="Guilliam de Bay - De hond van de hertog van alva" class="float-left image-lines-7">
    ...
    <section>
        <p>
            <img src="/images/pieter_gakel.jpg" alt="Pieter Gakel" class="float-left image-lines-3">
    ...
    <section>
        <p>
            <img src="/images/alexander_van_der_capellen.jpg" alt="Alexander van der Capellen" class="float-left image-lines-11">
    ...
    <section>
        <p>
            <img src="/images/johannes_visscherus.jpg" alt="Johannes Visscher(us)" class="float-left image-lines-4">
    ...
    <section>
        <p>
            <img src="/images/nova_zembla.jpg" alt="Nova Zembla" class="float-left image-lines-6">
    ...
    <section>
        <p>
            <img src="/images/willem_sluiter.jpg" alt="Willem Sluiter" class="float-left image-lines-6">
...
Indien eens ’t kwaaie geweten kom’,
    ...
    <section>
        <p>
            <img src="/images/willem_van_swaanenburg.jpg" alt="Willem van Swaanenburg" class="float-left image-lines-9">
