<article>
    ...
    <section>
        <p>
            <img src="/images/berendina_van_rensinck.jpg" alt="Berendina van Rensinck" class="float-left image-lines-6">
...
Gereinigd door ’t geloof, bezield van ’s Heilands min,
    ...
    <section>
        <p>
            <img src="/images/godewardus_vrolikhert.png" alt="Godewardus Vrolikhert" class="float-left image-lines-6">
...
Dank hebb’ lievdadigheid, die zoo blymoedig schoot.
    ...
    <section>
        <p>
            <img src="/images/hessel_vegelin_van_claerbergen-wapen.png" alt="Hessel Vegelin van Claerbergen" class="float-left image-lines-10">
    ...
    <section>
        <p>
            <img src="/images/matthias_theodorus_peypers.jpg" alt="Matthias Theodorus Peypers" class="float-left image-lines-9">
    ...
    <section>
        <p>
            <img src="/images/barend_fremery.jpg" alt="Barend Fremery" class="image-lines-6">
...
Betoovrend, schoon en schittrend heten?
    ...
    <section>
        <p>
            <img src="/images/pieter_bondam.png" alt="Pieter Bondam" class="image-lines-7">
    ...
    <section>
        <p>
            <img src="/images/hendrik_johan_arntzenius.jpg" alt="Hendrik Johan Arntzenius" class="image-lines-8">
    ...
    <section>
        <p>
            <img src="/images/johan_willem_simon_van_haersolte.jpg" alt="Johan Willem Simon van Haersolte" class="image-lines-11">
    ...
    <section>
        <p>
            <img src="/images/adam_leonard_kaldenbach.jpg" alt="A.L. (Adam Leonard) Kaldenbach" class="image-lines-8">
...
’t Zal met mij ten Hemel zwinden –
    ...
    <section>
        <p>
            <img src="/images/frederik_van_pallandt_van_keppel.jpg" alt="Frederik Willem Floris Theodorus baron van Pallandt van Keppel" class="image-lines-9">
    ...
    <section>
        <p>
            <img src="/images/johannes_florentius_martinet.gif" alt="Johannes Florentius Martinet" class="image-lines-11">
            ...
            <br>
            <img src="/images/johannes_florentius_martinet-katechismus.jpg" alt="Kleine katechismus der natuur voor kinderen" class="image-lines-13">
...
‘Ja, wacht eens even. Natuurlijk zegt die mij iets. Hij is de filosoof die in dat koepeltje hier aan de IJssel heeft gewerkt. Ik heb eens iets van hem gelezen, de Katechismus der Natuur. Daarin stonden geprezen tussen een meester en zijn leerling opgetekend. Ik vond het een vervelende titel voor een werk van uitmuntend gehalte. Hij wist ongelooflijk veel van kruiden, planten, bloemen, noem maar op. Een man van de Verlichting, die Martinet, en ook een onbekrompen dominee als ik me niet vergis. Geloofde in de vooruitgang, de heilzame kracht van een gedegen opvoeding en zo. Dat deden vele van zijn tijdgenoten. Hij werd druk gelezen, overal verschenen vertalingen van zijn werk. In Frankrijk en Engeland is hij tamelijk populair geweest. Iemand vertelde me dat er zelfs een Japanse versie van zijn Katechismus bestaat. Nogal uitzonderlijk in de achttiende eeuw. Maar hij is nu toch wel vergeten, geloof ik. Waarom vraag je me naar die man?’
        ...
        <p>
            <img src="/images/martinet-boergonjetoren.jpg" alt="Huis van Martinet" class="image-lines-7">
    ...
    <section>
        <p>
            <img src="/images/harmen_thieden_ament.jpg" alt="Harmen Thieden Ament" class="image-lines-11">
...
Wie, wie zou u niet vreezen,
    ...
    <section>
        <p>
            <img src="/images/jan_hendrik_reisig.jpg" alt="Jan Hendrik Reisig" class="image-lines-7">
...
Dan, als het stof zal zegepralen,
    ...
    <section>
        <p>
            <img src="/images/gerardus_wilhelmus_boot.jpg" alt="Gerardus Wilhelmus Boot" class="image-lines-7">
...
Uw roosje, uw’ angelier, waarop we U hoorden roemen,
    ...
    <section>
        <p>
            <img src="/images/wilhelm_broes.jpg" alt="Wilhelm Broes" class="image-lines-7">
    ...
    <section>
        <p>
            <img src="/images/quinten_maurits_rudolph_ver_huell.jpg" alt="Quinten Maurits Rudolph Ver Huell" class="image-lines-8">
        ...
        <p>
            ...
            <br>
            <img src="/images/alexander_ver_huell.jpg" alt="Alexander ver Huell" class="image-lines-9">
...
Van der Elst schrijft de goede Henri E. – en zoo iemand verdiende hij dien schoonen bijnaam. Van anderen kan de goedhartigheid zich een enkele maal verloochenen – van Henri nooit. – Braver zoon en vriend, braver echtgenoot en vader was er nimmer. Allen die hem kenden zullen zich bewijzen herinneren van zijn edel, loyaal en généreus karakter. – Zijne hoogbejaarde moeder, wiens éénig kind hij is zal radeloos wezen. Alle minder gefortuneerde leden zijner familie zullen oneindig veel aan hem verliezen; want zijn edelmoedigheid strekte zich uit over allen. – Voor mij sterft een der gelukkigste vooruitzichten van mijn volgend leven weg. – hoeveel genoegen had ik er mij van voorgesteld nu de trein tot Zutphen weldra zal doorlopen, met hem onze oude, dagenlange wandeltogten te hervatten.
    ...
    <section>
        <p>
            <img src="/images/isaac_petrus_marie_willinck.jpg" alt="Isaac Petrus Marie Willinck" class="image-lines-9">
    ...
    <section>
        <p>
            <img src="/images/barthold_hendrik_lulofs.png" alt="Barthold Hendrik Lulofs" class="image-lines-8">
...
Zwieren, zweven, zwenken, zwaaijen:
    ...
    <section>
        <p>
            <img src="/images/hendrik_paul_kretschmer-zelfportret.jpg" alt="Hendrik Paul Kretschmer" class="image-lines-5">
...
’k Ben slechts een klein Poëet, als Vondel zing ik niet,
    ...
    <section>
        <p>
            <img src="/images/anthonie_van_deinse.jpg" alt="Anthonie van Deinse" class="image-lines-4">
