...
Ook een toon in ’t scheppingslied:
    ...
    <section>
        <p>
            <img src="/images/" alt="Ludolph Anne Jan Wilt baron Sloet van de Beele">
            <writer name="ludolphannejanwiltbaronsloetvandebeele" data-writer="ludolphannejanwiltbaronsloetvandebeele">L.A.J.W. (Ludolph Anne Jan Wilt) baron Sloet van de Beele</writer> (Voorst, 28 maart 1806 – Arnhem, 10 december 1890), een broer van Sloet tot Oldhuis (zie daar) was onder meer advocaat en procureur in Zutphen, gouverneur-generaal van Nederlands-Indië en lid van de Tweede Kamerlid. Ook was hij een eminent historicus; hij publiceerde o.a. <cite>Het kondichboek der stad Zutphen</cite> (1845). Maar wij noemen hem hier om <cite>Mijn verblijf te Kissingen</cite> (1855):
        </p>
        <blockquote>
...
Zoo ging het mij, toen ik Kissingen zoude bezoeken, om er genezing eender leverkwaal te vinden.
    ...
    <section>
        <p>
            <img src="/images/" alt="Jacob Nieuwenhuis">
            <writer name="jacobniewenhuis" data-writer="jacobniewenhuis">Jacob Nieuwenhuis</writer>, geboren 26 oktober 1777 in Alkmaar als zoon van een Deense koopvaardijkapitein annex winkelier in ‘jachtbenodigdheden en vuurwerken’, was van 1799 tot 1803 eerst proponent en vervolgens predikant bij de Lutherse gemeente in Zutphen en gaf tevens wiskunde aan de kadetten van de militaire school. Nieuwenhuis woonde op kamers bij de drogist-dichter Herman Revelman. In 1803 werd hij beroepen in Utrecht, in 1816 kreeg hij een leerstoel aan het Atheneum Illustre in Deventer en in 1822 werd hij hoogleraar in de bespiegelende wijsbegeerte aan de universiteit van Leiden, waarvan hij 1833 rector magnificus werd. Hij schreef over godsdienst, filosofie en natuurkunde. Maar ook poëzie: <cite>Het noodlot</cite> (1807).
            <br>
            Speciale vermelding verdienen ook zijn nimmer gepubliceerde <cite>Gedenkschriften van J. Nyegaard of J. Nieuwenhuis en eenige zijner tijdgenooten</cite> over de jaren 1777-1843. Dertien delen van samen 3970 pagina’s. Nieuwenhuis beschrijft alle fases van zijn leven: kinderjaren, schooltijd, carrière, vriendschappen, het opgroeien van zijn eigen kinderen, het leven aan de universiteit (‘onder professoren’), de collegestof, zijn reizen en zijn gezinsleven. In te zien op het Nationaal Archief in Den Haag. Nieuwenhuis overleed op 11 april 1857 op zijn buitengoed ‘Den Engh’ bij Vleuten. Nieuwenhuis was de grootvader van Ferdinand Domela Nieuwenhuis, oprichter van de socialistische beweging in Nederland.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Willem Bartholome Eduard Paravicini di Capelli">
            De artillerie-kapitein <writer name="willembartholomeeduardparavincidicapelli" data-writer="willembartholomeeduardparavincidicapelli">W.B.E. Paravicini di Capelli</writer> (de initialen staan voor Willem Bartholomé Eduard), geboren in Zutphen op 22 februari 1778, dankt hier een plekje door het dagboek dat hij als adjudant van generaal Jan Willem Janssens, gouverneur van Kaap de Goede Hoop, bijhield op hun gezamenlijke reis door de binnenlanden van de Kaapkolonie, maar dan niet zozeer door het officiële dagboek, getiteld <cite>Journaal en verhaal eener landreyse in den jaare 1803</cite>, als wel door het particuliere dagboek dat Paravicini had bijgehouden en waarin hij veel meer details had genoteerd. Dit laatste dagboek verscheen pas ver in de twintigste eeuw, in 1965 om precies te zijn oftewel 162 jaar na dato, onder de titel Reize in de <cite>Binnen-landen van Zuid-Africa. Gedaan in den Jaare 1803</cite>.
            <br>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="albertchristiaanvaneldikthieme" data-writer="albertchristiaanvaneldikthieme">Albert Christiaan van Eldik Thieme</writer> (Zutphen, 1803 – Groningen, 25 mei 1854), predikant der hervormde gemeente, hield veel van zijn vader Herman Carel Anton Thieme, boekhandelaar van beroep, want hij herdacht hem – <cite>Ach! wat is hij ongelukkig, wien de dood een vader rooft!</cite> – niet met een enkel gedicht maar met een heuse, 26 pagina’s tellende dichtbundel <cite>Hulde aan mijnen vader, ontslapen den 9 Junij 1826</cite>, die eindigt met de woorden:
        </p>
        <blockquote>
...
En keeren, stil getroost der oudren woning in!
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            Dat <writer name="jacobvosmaer" data-writer="jacobvosmaer">Jacob Vosmaer</writer>, geboren op 25 augustus 1783 in Den Haag, behalve arts ook schrijver was, was bij zijn leven al bekend door de publicatie van <cite>Grondbeginselen der natuurkunde van den mensch</cite> (1808), het ‘dichtstuk’ <cite>De menschenliefde</cite> (1818) en het <cite>Apothekers woordenboek, letter A-D</cite> (Zutphen 1822). Maar dat hij een scherpzinnig humorist uit de school van de Engelsman Laurence Sterne was, wiens humoristische meesterwerk Het <cite>Leven en de Opvattingen van de Heer Tristram Shandy</cite> (1767) in heel Europa navolging kreeg, dat bleek pas goed na Vosmaers dood. In de uit twee delen bestaande <cite>Nagelaten en verspreide letterarbeid</cite> (1826) bevond zich namelijk de uiterst vermakelijke, Sterniaanse ‘non-roman’ <cite>Het leven en de wandelingen van Meester Maarten Vroeg</cite>, waarvan tot dan toe alleen de abonnees van het tijdschrift <cite>Vaderlandsche Letteroefeningen</cite> gedeelten onder ogen hadden gekregen. Een andere titel van zijn hand, ook opgenomen in de <cite>Nagelaten en verspreide letterarbeid</cite>, is <cite>De kunst om lang te leven en wel te sterven</cite>.
        </p>
        <blockquote>
...
Ook is deze kunst geene kunst voor boeren en ambachtsluî: zij is, evenals de edele danskunst, of als de kunst om zich te vervelen, alleen geschikt voor die verheven zielen, welke eene zekere hoeveelheid ledigen tijd hebben te vullen, – en geld, om de Esculapen in beweging te zetten, – en zucht, om de oogen tot zich te trekken, – en die geen middel weten, om dat alles op eene andere wijze te doen. Alleen zulke menschen kunnen met eenige hoop op goed gevolg zich op die moeielijke kunst toeleggen, want alleen zij bezitten er den vereischten aanleg toe. En zonder natuurlijken aanleg is de kunst, om ziek te zijn, evenmin aan te leren, als de dichtkunst of eenige andere.
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            Liefst vier auteurs uit dit genre moeten hier speciale aandacht krijgen vanwege hun band met Zutphen. Dat zijn Willem Carel Wansleven Jr., D.M. Maaldrink, Emile Seipgens en A.S. de Blécourt, die verderop aan bod komen. Van die vier hoort ‘Maaldrink met zijne Zutfensche boeren en boerinnen’, zoals ik hem in een oude literatuurgeschiedenis beschreven zag, er dan weer eigenlijk niet bij. Want met Zutphen wordt in het geval van <writer name="danielmartinusmaaldrink" data-writer="danielmartinusmaaldrink">D.M. (Daniël Martinus) Maaldrink</writer> (Geesteren, 23 juni 1851 – Twello, 29 augustus 1891) de graafschap Zutphen en niet de stad Zutphen bedoeld. Zijn aan het volksleven ontleende verhalen verschenen in de <cite>Deventer Courant</cite>, de <cite>Provinciaalsch Overijselsche en Zwolsche Courant</cite> en in bladen als <cite>Eigen Haard</cite> en <cite>Huisvriend</cite> voordat ze gebundeld werden in: <cite>Uit de Graafschap. Schetsen uit het Geldersche dorpsleven</cite> (1887) en <cite>Kwik-me-dit, Kwik-me-dat! Schetsen uit het Geldersche dorpsleven</cite> (1889).
            <br>
            <img src="/images/" alt="">
            De stád Zutphen komt bij Maaldrink slechts voorbij in ‘Stroopen’, een van de verhalen uit de bundel <cite>Uit de Graafschap</cite>. In Zutphen moest je zijn als je voor het gerecht werd gedaagd: ‘Van morgen zal ’t dan wezen met Mientje. Gisternamiddag zijn Vlasman’s Harmen en Velders’ Jan van Zutphen gekomen, ieder met drie boeten van vijfentwintig gulden en de kosten. ’t Was nog meegevallen, want een week tevoren waren ze ook voor geweest en toen was er een opgestaan en die had gepraat van nog drie dagen zitten of nog meer geld, zooals ze wilden. Maar zij wilden liever geen van beiden. Meistentieds gink ’t zoo, zeien ze: ie hadden er gestaodig eene bi, die òvervrog, en daor luusterden ze dan ook nooit veulle naor. Hi was zooveulle als een veugelverschrikker in de arwten: um bange te maoken en anders niks!
        </p>
    </section>

    <section>
        <p>
            <writer name="willemcarelwanslevenjr" data-writer="willemcarelwanslevenjr">Willem Carel Wansleven Jr.</writer>, geboren 26 juni 1808 in Zutphen, trad niet in de voetsporen van zijn vader, die een drukkerij-boekhandel-bibliotheek had aan de Beukerstraat 63, maar werd predikant. Toch viel de appel niet ver van de boom, want Wansleven Jr. was actief als schrijver van dorpsnovellen. Zoals in die tijd gebruikelijk publiceerde hij zijn verhalen in jaarboekjes en almanakken. De geïnteresseerde Wansleven-fan raadplege het jaarboekje <cite>Christofilus, de Gelderschen Volksalmanak</cite> en het <cite>Christelijk Album</cite>. Afzonderlijk verschenen van hem een samen met <writer name="djweerts" data-writer="djweerts">D.J. Weerts</writer>, later burgemeester van Ambt Delden, geschreven bundel <cite>Rijmelarijen</cite> (Zutphen 1828), die echter ‘niet in den handel’ kwam en waarschijnlijk door beide heren als een jeugdzonde werd beschouwd, en een bundel <cite>Kleine verhalen</cite> (Zutphen 1863). Deze verhalen werden in de <cite>Vaderlandsche Letteroefeningen</cite> gunstig – zij het niet zonder een paar kritische kanttekeningen – besproken:
        </p>
        <blockquote>
...
Met vleug’len aan de voeten.
    ...
    <section>
        <p>
            <writer name="matthieuandrevanderbank" data-writer="matthieuandrevanderbank">Matthieu André van der Bank</writer>, geboren in Dordrecht op 19 juni 1791, was net als zijn vader Waalschs predikant. Na zijn studie in Leiden stond hij op de kansel in Ravenstein, Eindhoven, Vlissingen, Luik en Utrecht. In laatstgenoemde plaats overleed hij, op 28 november 1862.
            <img src="/images/" alt="">
            <br>
            Het is aan zijn huwelijk met de Zutphense Elisabeth Catharina Maria Theben Tervile, dochter van zeepfabrikant, postkantoordirecteur, raadslid en wethouder Joost Christiaan Theben Tervile, te danken dat zijn schriftelijke nalatenschap niet alleen uit ‘onderscheidene theologische werken in het fransch’ bestaat, maar ook het gedicht <cite>Het bruidje voor den hemel , of Iets voor de, in diepen rouw gedompelde Familie Tervile</cite> (Zutphen, 1818) bevat, waarvan hier de eerste strofes:
        </p>
        <pre>
...
De bruid hield op te leven.
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="petruscamper" data-writer="petruscamper">Petrus Camper</writer>, geboren 1797 in Franeker, was vanaf 1820 conrector aan de Latijnse school in Zutphen. Als dichter manifesteerde hij zich met een bundel <cite>Bloemenknopjes van onbekende inhoud, of eerste dichtkundige proeven</cite> (1818), <cite>Ode</cite> (1833), <cite>Antigone, treurspel, naar het Grieksch van Sophocles in Hollandsch dicht gevolgd</cite> (1834). <cite>De Fenisische vrouwen, treurspel naar Euripides</cite> (1823), geschreven in Zutphen, droeg hij op ‘Aan Friesland’:
        </p>
        <pre>
...
Een uwer telgen wien het wiss’lend lot mocht tronen
    ...
    <section>
        <p>
            -<writer name="hendriknicolaasvantil" data-writer="hendriknicolaasvantil">Hendrik Nicolaas van Til</writer>, geboren 5 april 1798 in Deventer, woonde het grootste deel van zijn leven in Zutphen, waar zijn vrouw, C.Ch.H.W. Zimmermann, een ‘dag- en kostschool voor meisjes’ had. Zelf was Van Til ambtenaar op het stadhuis. Behalve <cite>Het Geldersch schoolboek, of merkwaardige voorvallen van personen uit de geschiedenis van Gelderland</cite> (1830) en een <cite>Beknopte geschiedkundige en plaatselijke beschrijving der stad Zutphen en harer bevallige omstreken</cite> (1832, in 1974 herdrukt!) en meer van dergelijke werken schreef hij <cite>Wat een grootvader aan zijn kleinkinderen vertelde</cite> (1868).
            <br>
    ...
    <section>
        <p>
            -De militair <writer name="gerritkuyperhzn" data-writer="gerritkuyperhzn">Gerrit Kuyper Hzn</writer>, geboren 3 juli 1815 in Amsterdam en overleden 28 december 1879 in Den Haag, bracht zijn jeugd door in Zutphen. Behalve over technologie, zeevaartkunde en militaire onderwerpen schreef hij een tragedie: <cite>Asteroïs of Messene’s ondergang</cite> (1839).
        </p>
    </section>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="mevrvandertuuklenting" data-writer="mevrvandertuuklenting">Mevr. van der Tuuk-Lenting</writer>, kinderboekenschrijfster, werd op 25 maart 1822 als Petronella Helena Clasina Lenting geboren in Zutphen, waar haar vader rector van de Latijnse school was (haar moeder was een barones uit Versailles met Nederlandse voorouders). In 1840 verhuisde het gezin naar Groningen, waar vader Lenting benoemd was tot hoogleraar in de letteren. In de jaren vijftig begon Petronella Lenting – afwisselend onder het pseudoniem Helena en als Mevr. van der Tuuk-Lenting – kinderverhalen te schrijven met een sterk religieuze inslag. Als Helena schreef zij onder andere <cite>Uit het leven voor het leven</cite> (1863), <cite>De Heer is waarlijk opgestaan. Een Paaschvertelling</cite> (1866) en <cite>Het kind der wereld en het kind van God</cite> (1870), en onder haar eigen naam <cite>Uit de leerschool des levens. Nieuwe vertellingen voor de jeugd</cite> (1868) en <cite>Eenige sprookjes uit den vreemde naverteld</cite> (1870). Ook schreef zij ‘tooneelstukjes voor het salon’, zoals <cite>Oorlog en vrede. Blijspel in drie tafereelen</cite> (1877) en leverde zij bijdragen aan de <cite>Kindercourant</cite>, die vanaf 1852 wekelijks uitkwam en kinderen een ‘nuttige bezigheid’ wilde verschaffen. In het tijdschrift <cite>Vaderlandsche Letteroefeningen</cite> noteerde een recensent: dat zij altijd ‘de juiste kindertoon’ wist te treffen en dat ‘haar verhalen in de kindercourant steeds met graagte door het kleine volkje gelezen’ werden. Haar dochter Titia Klasina Elisabeth van der Tuuk (1854-1939) werd een bekend schrijfster – ook van kinderverhalen – en feministe. Petronella van der Tuuk-Lenting overleed op 27 februari 1900 in Arnhem.
        </p>
    </section>
...
En niet in marmer of cimment
    ...
    <section>
        ...
        <p>
            ...
            <br>
            Andere titels van Brunings hand: <cite>Distels en lauweren, militaire schetsen</cite> (1869), <cite>Het gezin van de rentmeester</cite> (1882), <cite>Mijn vriend Parelman</cite> (1884). Ook schreef hij brieven in <cite>De Amsterdammer</cite> onder het pseudoniem Pasquino. Brunings overleed op 4 juli 1889 in Den Haag.    
        </p>
    </section>

    <section>
        <p>
            -<writer name="franciscusclemenssoer" data-writer="franciscusclemenssoer">Franciscus Clemens Soer</writer> (in het bevolkingsregister staat: Clemens Franciscus), geboren 23 november 1826 [niet 1825] op de Nieuwstad A20 in Zutphen, studeerde letteren in Utrecht en werd rector van het gymnasium in Boxmeer en daarna van de Latijnse school in Oldenzaal, waar de eertijds fameuze katholieke voorganger de dichter Herman Schaepman een van zijn leerlingen was. Soer was hoofdredacteur van het weekblad <cite>Nederlandsche Katholieke Stemmen</cite>. In de reeks <cite>Uitspanningslectuur, toegewijd aan wetenschap, kunst en smaak</cite> (1850-55) verschenen van Soers hand opstellen alsmede de novelle <cite>Adelheide, een verhaal uit de tiende eeuw</cite>. Daarnaast schreef hij feuilletons in de <cite>NRC</cite>, waaronder <cite>Opmerkingen van een Noord-Brabander</cite>, en gelegenheidsgedichten. In 1866 werd hij leraar aan de Rijks HBS in Tilburg. Hij overleed op 31 maart 1897 in Ginniken (Breda).
        </p>
    </section>

    <section>
        <p>
            -<writer name="jankarelbadonghijben" data-writer="jankarelbadonghijben">Jan Karel Badon Ghijben</writer> werd op 23 september 1805 geboren in Arnhem, maar ‘nog in zijne vroegste jeugd verwisselden zijne ouders van woonplaats en vestigden zich, wegens de verschillende ambtsbetrekkingen zijns vaders, achtervolgens te ’s Gravenhage, te Amsterdam en eindelijk te Zutphen’. Het was hier ‘dat zijne verstandelijke en zedelijke vorming werd begonnen, zoo door verschillende onderwijzers, aan welken hij werd toevertrouwd, als vooral door zijnen regtschapen vader en zijne godsdienstige moeder. Hij was een vurig beminnaar van de schoone kunsten, alsmede van de afgetrokkene, wiskunstige wetenschappen’. U ziet, het was harmonie wat de klok sloeg, in Jan Karel Badon Ghijbens leven. Die wiskunstige wetenschappen werden hem trouwens bijgebracht door niemand anders dan… Hendrik Paul Kretschmer.
            <br>
...
D’ eigen blos weêr op uw’ kaken
    Lieve kleine, sluimer zoet!
        ...
        <p>
            Later volgde <cite>Chassé aan de zijnen en het vaderland teruggegeven</cite> en, in proza, <cite>De val van het Kasteel van Antwerpen</cite>. Badon Ghijben trouwde op 15 september 1832 met de Zutphense Hester Catharina Gerarda Frucht en overleed op 18 februari 1843 in Arnhem.
        </p>
    </section>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="abrahamfaurebeeckman" data-writer="abrahamfaurebeeckman">Abraham Faure Beeckman</writer>, op 4 oktober 1797 geboren in Soerabaya, trouwde op 1 mei 1823 in Zutphen met Helena Alijda Hoffman en was van 1827-1839 predikant in Voorst, waarna hij om mij onbekende redenen ambteloos werd. Een jaar later verscheen – anoniem – zijn eerste literaire werk: <cite>Pater Gozewien en de twee huisgezinnen</cite> (1840). Andere titels van zijn hand zijn: <cite>Het huisgezin van Doorenbos. Een verhaal</cite> (1851) en <cite>De waarheidsliefde. Schetsen</cite> (1857). Hij vond <cite>Jenever erger dan oorlog</cite> (1858). In 1875 publiceerde hij <cite>Cornelis Hoek en zijn Zutfensche vrienden; Een belangrijke bladzijde uit den tachtigjarigen oorlog</cite>. Op 22 februari 1886 overleed Faure Beeckman in Santpoort.
        </p>
    </section>

    <section>
        <p>
            -<writer name="janaikeskramer" data-writer="janaikeskramer">Jan Aikes Kramer</writer>, geboren 8 maart 1802 in Groningen, was luthers predikant in Zutphen van 1829-1835. Daarna vertrok hij naar Den Haag, waar hij op 10 december 1873 stierf. Behalve werken op zijn vakgebied schreef hij <cite>Reisherinneringen en gedachten</cite> en, in het tijdschrift <cite>Vaderlandsche Letteroefeningen</cite>, het gedicht ‘De Voorzienigheid’.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Adriaan van den Ende">
            In 1792 was domineemauritsalbrechtamshoff <writer name="adriaanvandenende" data-writer="adriaanvandenende">Adriaan van den Ende</writer> medeoprichter geweest van het Natuur- en letterkundig genootschap Prodesse Conamur in Arnhem, maar anders dan veel van zijn collega’s in die tijd werd hij niet de zoveelste dominee-dichter. Nadat een ziekte hem dwong de kansel te verlaten stortte hij zich op de verbetering van het onderwijs. In opdracht van ‘den Agent van Nationale opvoeding’ schreef hij het <cite>Handboek voor de onderwijzers op de openbare lagere scholen binnen het Bataafsche Gemeenebest</cite> (1803) en drie jaar later stelde hij samen met de dominee-dichter Johannes van der Palm een onderwijswet op die een halve eeuw stand hield en zaken regelde die nu volkomen vanzelfsprekend zijn maar toen zeer nieuwerwets: dat leraren klassikaal les moesten geven en een lesbevoegdheid moesten hebben, dat ouders schoolgeld moesten betalen enz. Van den Ende, op 11 oktober 1768 geboren in Delft, was getrouwd met Anna Gesiena Toewater, dochter van de stadssecretaris van Zutphen, en na zijn pensionering in 1832 vestigden zij zich op het Geesink, ‘een familie-buitentje’, in Warnsveld. Daar vond hij de tijd en de rust om zich weer om de letteren te bekommeren. Hij bracht Alexander Pope’s filosofische dichtstuk <cite>The Essay on Man</cite> over ‘in Nederd. verzen’: <cite>Proeve over den Mensch</cite> (1839). Dat was bepaald geen sinecure, want Pope had zijn werk geheel geschreven in ‘heroic couplets’, een versvorm die vooral in de Engelse poëzie werd gebezigd en waar Pope de grootmeester van was. Heroic couplets bestonden uit ‘groepen van twee paarsgewijs rijmende regels, meestal in mannelijk rijm, volgens het rijmschema aa bb. Deze couplets bestaan uit jambische pentameters, wat inhoudt dat elke regel vijf jambische versvoeten bevat en derhalve bestaat uit tien lettergrepen. De couplets zijn gesloten, dat wil zeggen dat zij een afgesloten gedachtegang bevatten, die wordt beëindigd met een leesteken.’ Aldus Wikipedia. Van den Ende overleed op 28 juni 1846. In Warnsveld is er een basisschool naar hem vernoemd en op de begraafplaats aldaar is een gedenkteken voor hem opgericht. Het Geesink is in de 19e eeuw gesloopt.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Catharina F. (Felicia) van Rees">
            Indien <writer name="catharinafeliciavanrees" data-writer="catharinafeliciavanrees">Catharina F. (Felicia) van Rees</writer>, geboren 22 augustus 1831 in Zutphen, tot een ietsje eenvoudiger milieu had behoord, was zij ongetwijfeld componiste geworden. Op haar vijfde componeerde ze al stukjes voor piano, en ze had zoveel succes met haar composities dat ze, na een uitvoering van haar komische opera <cite>Les débutants</cite> in Utrecht, werd uitgenodigd naar Parijs te komen om daar verder te studeren. Op advies van haar moeder nam zij deze uitnodiging niet aan: een muziekcarrière was beneden haar stand, zoiets deed een dame niet. Componeren bleef ze, maar enkel als liefhebberij. In het <cite>Biografisch woordenboek van Nederland</cite> lezen we: ‘Tot 1874 alleen al verschenen er minimaal dertig composities in druk, voornamelijk bestemd voor de piano met en zonder zang.’ In 1875 componeerde Van Rees het ‘Transvaalse volkslied’, waarvoor ze ook de tekst schreef:
        </p>
        <pre>
...
(Catharina F. van Rees, uit ‘Getrouw tot in den dood; De Ulaan en zijn hond’, uit de bundel Van dezelfde familie, 1884)
    ...
    <section>
        <p>
            <img src="/images/" alt="Isaäc Groneman">
            <writer name="isaacgroneman" data-writer="isaacgroneman">Isaäc Groneman</writer>, op 15 augustus 1832 geboren aan de Raadhuissteeg C214 (nu Lange Hofstraat 21) in Zutphen, was ‘genees-, heel- en verloskundige’ in Vorden alvorens hij in 1858 naar Indië vertrok. In Nederland had hij af en toe een gedicht in een tijdschrift gepubliceerd en een nimmer uitgegeven maar wel door enkele rederijkerskamers uitgevoerd treurspel getiteld <cite>Het slot Nijenbeek</cite> op zijn naam gebracht. Maar in Bandung, en later in Djokjakarta, schreef hij een niet onaanzienlijk oeuvre bij elkaar. In de meeste van zijn geschriften is hij als geneesheer aan het woord (hij was lijfarts van de sultan van Java), en in de meeste gevallen richtte hij zich daarbij tot vakgenoten. Met zijn <cite>Bladen uit het dagboek van een Indisch geneesheer</cite> (1874), <cite>Indische schetsen</cite> (1875, uitgegeven door Van Someren) en <cite>Waar of onwaar? Nieuwe Indische schetsen</cite> (1879) zocht en vond hij echter een breder publiek. In zijn woord vooraf bij de Indische schetsen voerde Groneman een fraaie variant op de uitgekauwde verzekering dat elke gelijkenis met bestaande personen op toeval berust, op:
        </p>
        <blockquote>
...
Meent nu deze of gene zich toch in mijn schetsen te herkennen, dan bewijst dit alleen dat hij in eigen oogen wel wat op mijn voorstelling gelijkt – dat mijn schuld niet is, maar dat dan voor de natuurlijkheid van mijn schetsen zou pleiten.
    ...
    <section>
        <p>
            <img src="/images/" alt="H.J.H. (Hendrik Jan Herman) Groneman">
            <writer name="hendrikjanhermangroneman" data-writer="hendrikjanhermangroneman">H.J.H. (Hendrik Jan Herman) Groneman</writer> (Zutphen, 14 juni 1840 – Velp, 5 maart 1908), de jongere broer van Isaäc Groneman en net als deze geboren aan de Raadhuissteeg C214 (nu Lange Hofstraat 21), was ingenieur en leraar wis- en werktuigkunde, cosmografie en lijntekenen. Hij woonde een tijdlang in Zutphen, waar hij in het gemeentearchief en het archief van de Walburgkerk werkte. Groneman schreef hoofdzakelijk over natuurkundige en oudheidkundige onderwerpen, maar ook: <cite>Wilde Andries</cite> (Zutphen 1890) en in Zutphens dialect het gedicht ‘Van ’t nachtegäoltjen en de poes’ in de <cite>Geldersche Volks-Almanak</cite> van 1904. Op de foto zien we ir. Groneman (met wandelstok) op de Wolfhezerheide, waar eind 19e eeuw de fundamenten van een 11e-eeuws kerkje werden ontdekt.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="A.C.W. (Anthony Christiaan Wynand) Staring">
            De dichter <writer name="anthonychristiaanwynandstaring" data-writer="anthonychristiaanwynandstaring">A.C.W. Staring</writer> (de initialen staan voor Anthony Christiaan Wynand, maar deze namen komen voor op alle mogelijke manieren gespeld) noemde zijn bekende gedicht ‘Het vogelschieten’ een ‘Zutphense vertelling’, terwijl de eerste strofe al meteen duidelijk maakt dat de plaats van handeling niet Zutphen is:
        </p>
        <blockquote>
...
Waarme de Vloer ’t gebeurde aan ’t nageslacht zal klappen.
        ...
        <p>
            Staring werd geboren in Gendringen op 24 januari 1767 en hij overleed op 18 augustus 1840 op De Wildenborch. Drie jaar na Starings dood publiceerde de goed met hem bevriende en hiervoor al genoemde dichter B.H. Lulofs de eerste Staringbiografie, getiteld <cite>Gelderlands voortreffelijke dichter, letter- en landhuishoudkundige Mr. A.C.W. Staring van den Wildenborch, in zijn leven, karakter en verdiensten geschetst door zijn Oud Zutphenschen landman en vriend</cite>. In 1981 gaf de Zutphense boekhandelaar-uitgever-schrijver Ad ten Bosch de <cite>Verzamelde gedichten</cite> van Staring uit.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Gerrit van Gorkom">
            De letterkundige benevens predikant <writer name="gerritvangorkom" data-writer="gerritvangorkom">Gerrit van Gorkom</writer>, geboren op 30 augustus 1833 op het adres Gasthuis 96 in Zutphen, was ‘een meester in de polemiek tegen de orthodoxie rechts en de vrijdenkerij links’. Samen met Hendrik de Veer, hoofdredacteur van <cite>Het Nieuws van den Dag</cite> en romanschrijver (<cite>Trou-ringh voor ’t jonge Holland</cite>, 1868), voerde Van Gorkom van 1868 tot 1874 de redactie over het tijdschrift <cite>Los en Vast</cite>, waarvoor hij in die zes jaar niet minder dan 67 essays schreef. Van Gorkom overleed op 14 januari 1905 in Amsterdam. Volgens het bevolkingsregister heet hij overigens Gerret van Gorkom.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Theodoor Cornelis Reinier Huydecoper">
            <writer name="theodoorcornelisreinierhuydecoper" data-writer="theodoorcornelisreinierhuydecoper">Theodoor Cornelis Reinier Huydecoper</writer>, geboren 13 februari 1805 in Hoorn, was van 1834 tot 1838 predikant in Zutphen, waarna hij naar Den Haag verhuisde, waar hij op 16 januari 1866 overleed. Huydecoper spande zich zeer in voor de afschaffing van sterke drank, en daat deed hij door middel van brochures die titels droegen als <cite>Een woord van ernst en liefde aan mijne landgenooten</cite> (1845) en <cite>De sterke drank zooals hij den mensch verhindert, zichzelven te beheerschen</cite> (1847). Daarnaast waagde hij zich ook op het gebied van de fictie met de roman <cite>Het huisgezin van vader Reinhard</cite> (1848), maar, beducht wellicht voor zijn goede naam als predikant, deed hij dat anoniem.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Johannes Christoffel Schultz Jacobi">
            <writer name="johanneschristoffelschultzjacobi" data-writer="johanneschristoffelschultzjacobi">Johannes Christoffel Schultz Jacobi</writer>, geboren in Amsterdam op 3 oktober 1806, was van 1837 tot 1846 predikant van de Evangelisch-Lutherse gemeente in Zutphen; voordien had hij in Leeuwarden en Culemborg gepreekt. Schultz Jacobi woonde in de Bernhardsteeg E251. Hij schreef godsdienstkundige, letterkundige en oudheidkundige artikelen, maar had ook ‘buitengewoon behagen in het lezen en maken van verzen’. Zijn ‘dichterlijken aanleg’ openbaarde zich al op jonge leeftijd, getuige onder meer zijn gedicht ‘De Vadermoorder’, dat hij schreef op zijn 14de. Zie de volgende regels:
        </p>
        <pre>
...
En dit vermeerderde het akelige duister
    Van dezen bangen stond.’
        ...
        <p>
            De meeste van Schulz Jacobi’s gedichten – hij schreef zowel in het Nederlands als het Fries – verschenen in jaarboekjes en almanakken, maar als afzonderlijke publicaties zijn te noemen zijn in Zutphen geschreven <cite>Gedichten, bloemen uit Salomo’s gaard</cite> (1843) en <cite>Nederlandsche Legenden, Beeldjes voor een Nederlandschen Doodendans</cite> (1849).
            <br>
...
Die altijd werkzaam was, maar nooit iets groots volbragt.
    ...
    <section>
        <p>
            <img src="/images/" alt="W.R. (William Robert) Veder">
            <writer name="williamrobertveder" data-writer="williamrobertveder">W.R. (William Robert) Veder</writer>, geboren 9 augustus 1808 in Rotterdam, studeerde godgeleerdheid in Leiden, waar hij redacteur van de studentenalmanak was, samen met onder anderen Gerrit van der Linde, die later beroemd werd door zijn <cite>Gedichten van den Schoolmeester</cite>. Na zijn studie werd Veder dominee in Heiloo, waar hij werd opgevolgd door de dominee-schrijver J.P. Hasebroek, beter bekend onder zijn schuilnaam Jonathan, die er de zogeheten ‘Kring van Heiloo’ in het leven riep, een vriendenclub waartoe Nicolaas Beets, Johannes Kneppelhout, Truitje Bosboom-Toussaint en vele andere schrijvers behoorden. Van 1838 tot 1842 stond Veder in Zutphen op de kansel. Hij nam actief deel aan het culturele leven van Zutphen, want hij was lid van het genootschap Physica en van de Maatschappij tot Nut van ’t Algemeen en hield voor beide clubs regelmatig voordrachten. Veder was bevriend met schrijvers als Jacob van Lennep en De Schoolmeester en schreef ook zelf, zij het zonder veel pretentie en ambitie. Hij publiceerde gedichten in diverse almanakken, maar een eigen dichtbundel, <cite>Berijmde verhalen</cite> (1858), liet hij privé drukken; alleen zijn vrienden ontvingen er een exemplaar van. De Koninklijke Bibliotheek bewaart een verzameling brieven van en aan Veder; correspondenten zijn onder meer Frederik van Eeden, Cornelis Veth, Pieter Lodewijk Tak en George Hendrik Breitner. Veder overleed op 12 juni 1882 in Amersfoort. Zijn tweelingbroer Aart komt de eer toe de bedenker te zijn van het door De Schoolmeester onsterfelijk geworden grafschrift: <i>‘Hier ligt Poot. / Hij is dood.’</i>
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Louis Armand Hissink">
            <writer name="louisarmandhissink" data-writer="louisarmandhissink">Louis Armand Hissink</writer>, op 31 juli 1812 geboren in Parijs, was enige tijd onderwijzer in Utrecht voordat hij, in 1842, naar Zutphen kwam. Hij betrok een pand aan de Waterstraat 38 en stichtte er een Franstalige kostschool, het ‘pensionnat Français Municipal’. Hij doceerde er Frans, Duits, Engels, algemene geschiedenis en Fabelleer en publiceerde diverse lesboeken, waaronder een <cite>Verzameling van spreekwoorden en spreekwoordelijke gezegden der Fransche taal. Bijeen gebragt, gerangschikt en in het Nederlandsch vert., om de beoefening van deze beide talen en de kennis van hare eigenaardigheden te bevorderen</cite> (1858).
            <br>
...
Zing daarbij,
    Tot des Heren lof en prijs.
        ...
        <p>
            Door te schrijven voor jongeren hoopte De Liefde ‘de harten der jeugdige lezers opmerkzaam te maken op de uitnemende voorrechten van de vreeze des Heeren, en hen op te wekken tot ernstige belangstelling in de bekeering van Israël en de Heidenen’. Titels in dit christelijk-pedagogische genre zijn onder veel meer: <cite>De diligence, of de reis naar de stad der erfenis</cite> (1845), dat is gemodelleeerd naar de beroemde <cite>The Pilgrim’s Progress</cite> (<i>Christenreis</i>) van John Bunyan, en <cite>Nathan, de kajuitsjongen, of de reis naar Jeruzalem</cite> (1848). In 1849 richtte De Liefde het tijdschrift <cite>Timotheus, tijdschrift voor de jeugd</cite> op. Het beleefde zeven jaargangen. De inhoud bestond uit verhalen, gedichten, liederen, anecdoten, raadsels, eenvoudige opstellen over geschiedkundige, aardrijkskundige, natuurkundige en werktuigkundige onderwerpen, zendingsgeschiedenissen, enzovoort. De Liefde was de enige redacteur. In 1856 richtte hij de Vrije Evangelische Gemeente op. In 1864 vertrok hij naar Londen om voor de Engelse pers te schrijven. Vier jaar later vestigde hij zich in Amsterdam, waar hij op 6 december 1869 overleed. De Liefde woonde aan de Waterstraat C70 en Bornhove 218.
        </p>
    </section>

    <section>
        <p>
            –<writer name="johannaelisabethhelmcke" data-writer="johannaelisabethhelmcke">Johanna E. (Elisabeth) Helmcke</writer> (ook: van de Velde-Helmcke), geboren op 4 november 1762 in Amsterdam, is het bekendst gebleven als dichteres van vier van de <cite>Evangelische Gezangen</cite> (voor de liefhebbers: 2, 50, 79 en 85). In het Luthers Gezangboek zijn van haar opgenomen de gezangen 146 en 168.  En aan de doopsgezinde <cite>Christelijke Gezangen voor de openbare godsdienstoefeningen</cite> droeg ze ook nog eens tien gezangen bij, die indertijd populair waren om ‘hun welluidendheid en vloeiende versificatie’. Nummers wilt u? Hier dan: 33, 85, 91, 107, 113, 121, 133, 144, 147. 155. Zij was lid van het ‘Amsteldamsch dicht- en letteroefenend genootschap’, dat haar dichtstuk <cite>Nehemia</cite> bekroonde, en van de vereniging ‘Hierna volmaakter’, waarvoor ze onder andere <cite>Gedachten bij den morgenstond</cite> en <cite>De lof der naarstigheid</cite> schreef. Haar gedichten zijn nooit gebundeld. Helmcke overleed op 26 oktober 1844 in Zutphen, waar haar zoon predikant was. Zij woonde in de Kuiperstraat C74.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Albert Evert Carel van Someren">
            In 1844 opende <writer name="albertevertcarelvansomeren" data-writer="albertevertcarelvansomeren">Albert Evert Carel van Someren</writer> aan de Turfstraat 19 de nog altijd bestaande boekhandel Van Someren.  De op 28 januari 1821 in Arnhem geboren Van Someren leverde niet alleen als boekhandelaar een bijdrage aan het literaire leven in Zutphen, maar ook als vertaler van romans die er nu niet zoveel meer toe doen (want wie kent nog <cite>Een vrouw uit de tropen</cite> van Florence Marryat of <cite>Kleine menschen</cite> van Sara Hützler?) én als dichter. Tot een zelfstandige bundel is het niet gekomen; Van Somerens gedichten zoeke men in het jaarboekje <cite>Christophilus</cite> en in de <cite>Gelderschen Volksalmanak</cite>. Van Someren overleed in Zutphen op 16 mei 1890.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Joris Bromminck">
            <writer name="jorisbromminck" data-writer="jorisbromminck">Joris Bromminck</writer> is de schrijver van een klein satirisch oeuvre. Zijn eigenlijke naam was Adolf Frederik Henri de Lespinasse (Delft, 14 mei 1819). De Lespinasse, van vaders zijde van Franse, van moeders zijde van Zweedse adel, ging in 1836 geneeskunde studeren in Utrecht en richtte er met medestudent Hendrik Jan Broers (1815-1876) het humoristische blad <cite>Gedenkschriften van eenen student</cite> op. Het verscheen anoniem – ‘des schrijvers naam is onbekend, wat doet ook de naam tot de zaak?’ –, wat aansloot bij de spectatoriale traditie en de redacteuren des te meer vrijheid gaf om te zeggen wat ze wilden. In drie jaar (1838-1841) verschenen er vijftien afleveringen. In 1840 publiceerde De Lespinasse onder het pseudoniem Joris Bromminck twee toneelstukken, <cite>Vorstin en vrouw, Jacoba, Gravin van Holland</cite>, een historisch drama in vijf bedrijven dat in de Amsterdamse schouwburg werd opgevoerd, en <cite>De arts in tafreelen</cite>. In 1842 volgden <cite>Academisch legaat van een oud-student</cite>, een bundel losse humoristische schetsen, en de humoristische roman <cite>Mijn neef Zacharias</cite>.
            <br>
            Mijn neef Zacharias werd in de <cite>Vaderlandsche Letteroefeningen</cite> laatdunkend weggezet als een ‘soort van Pickwickiaansch romannetje’, geschreven ‘in navolging van meer hedendaagsche lach-schrijvers’. ‘Niet, dat er niets goeds in is – onder veel geleuter en gebabbel is zelfs echte humor, dien zelfs Sterne zich niet zou behoeven te schamen. Jammer maar, dat het slechts op enkele plaatsen is.’
            <br>
            Na een kort verblijf in Deventer en Zwartsluis, werd De Lespinasse in 1843 benoemd tot gemeentearts in Voorst, de geboorteplaats van zijn goede vriend Anthony Winkler Prins, de latere encyclopedist, wiens ouders er een apotheek dreven. In de vier jaar dat De Lespinasse in Voorst verbleef, drukte hij als lid van de Geneeskundige Kring Zutphen zijn stempel op de modernisering van de geneeskunde door aan de wieg te staan van de Koninklijke Nederlandse Maatschappij der Geneeskunde. ‘Hij bracht,’ heette het bij het 50-jarig van de KNMG, ‘de noodzakelijkheid eener herziening van onze geneeskundige wetten ter sprake en gaf tevens middelen aan tot verheffing van de achting voor den geneeskundigen stand. Hij nam het initiatief tot het oprichten van geneeskundige kringen in andere streken van ons land en sprak reeds de wenschelijkheid uit voor het bijeenroepen van geneeskundige congressen.’ En daarom kwam hem de naam toe van ‘vader der Maatschappij der Geneeskunde’. Daarnaast vond De Lespinasse ook nog de gelegenheid om zijn alter ego Joris Bromminck het ‘dramatisch romantisch verhaal’ <cite>Anitta d’Ulloa, of de dubbele eed van trouw</cite> (1846) en <cite>Waarachtige physiologie van den student of het kieken in den dop</cite> (1846) te laten schrijven.
            <br>
            In 1847 werd De Lespinasse benoemd in Vaassen. Hij publiceerde er een <cite>Alphabetisch artsenij-zakboek, met inachtneming der nieuwe Nederlandsche pharmacopea</cite> (1854) en samen met zijn jongere broer Adolphe Frederik het Kort begrip der theoretische en practische verloskunde (1854). Onder het pseudoniem Titus publiceerde hij in <cite>De Dageraad</cite>, het tijdschrift van de gelijknamige vrijdenkersvereniging, ‘Losse bladen en aantekeningen’, waarin hij zich een navolger van Multatuli’s <cite>Ideën</cite> betoonde. De rubriek verscheen in de jaren 1862-1865 en kende veertien afleveringen met in totaal 157 doorgenummerde stukjes waarin De Lespinasse van leer trok tegen alles wat met predikanten, kerk en godsdienst te maken heeft. Lees bijvoorbeeld zijn stukje nummer XXIII:
        </p>
        <blockquote>
...
Christenen doet gij verstandiger?
        ...
        <p>
            Literair was Vaassen een vruchtbare periode voor De Lespinasse. Als Titus kon hij zijn vrijdenkersei kwijt, als Joris Bromminck schreef hij het blijspel in verzen <cite>Een kamer in het huis van Jan Salie, komische schets van Nederlandsche zeden in de laatste Jaren</cite> (1853), onder het pseudoniem Dr. L. droeg hij gedichten bij aan de <cite>Muzen-Almanak</cite> en het ‘tweemaandelijksch tijdschrift voor Nederlandsche poëzij’ <cite>Daphné</cite>, en verder verschenen van zijn hand opstellen in het <cite>Jaarboekje voor Vrijmetselaars en het Maçonniek Weekblad en de publicatie Eeuwgeest en vrijmetselarij</cite> (1855).
            <br>
            In 1863 vertrok De Lespinasse naar Hasselt, de plaats waar hij zijn jeugdjaren had doorgebracht. Hij verzamelde er zijn verspreide literaire geschriften in <cite>Mozaiek-werk in proza en poesie van 5845-5868 bijeengebracht voor B.B. V.V. M.M.</cite> [volgens de maçonnieke jaartelling A.L. – Anno Lucis, d.w.z. volgens ‘het jaar van het ware licht’ – is het jaartal vierduizend hoger dan bij de gangbare kalender – HH] en vertrok in 1870 naar Orange City, Iowa, waar hij een boerderij dreef en een artsenschool oprichtte, en op 26 maart 1881 overleed.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Zenobie van Lennep">
            Met de uitgave van <cite>Uwe liefhebbende Zenobie. Correspondentie van Zenobie van Lennep uit de jaren 1846-’69</cite> (2014) heeft Koen Fijma een fraai monument opgericht voor een schrijfster uit de marge van de Nederlandse literatuur. Meer dan een handvol verhalen en opstellen heeft ze niet geschreven. In 2011 zijn die opgediept uit de tijdschriften en almanakken waarin ze oorspronkelijk gepubliceerd zijn en – ruim 150 jaar na dato – voor het eerst in boekvorm uitgegeven. Aan dit bescheiden uitgaafje van niet meer dan 75 bladzijden, getiteld <cite>Mijn geliefd Enkhuizen</cite>, is dus nu haar – veel interessantere – correspondentie toegevoegd.
            <br>
            <writer name="zenobievanlennep" data-writer="zenobievanlennep">Zenobie van Lennep</writer> werd op 23 februari 1820 in Den Haag geboren als dochter van Gerrit van Lennep, redacteur van de <cite>Staatscourant</cite>, en Berendina Joanna van Jordan. Na de dood van haar vader in 1833 verhuisde ze met haar moeder naar Zutphen, ‘doch de leefwijze aldaar was veel te duur’ en daarom kocht haar moeder met het geld dat zij ‘bij den afrekening van den ouderlijke boedel ontving’ een huis in haar geboorteplaats Enkhuizen voor ƒ 1900’. Het eerste deel van de brieven stamt uit de Enkhuizer jaren. Na de dood van haar moeder, in 1850, verhuisde Zenobie weer naar Zutphen, waar ze de rest van haar leven woonde.
            <br>
            Haar voornaamste correspondenten waren de beroemde schrijver Jacob van Lennep, een verre neef, Van Lenneps buitenechtelijke dochter Betje Fievez en de eminente Leidse professor Hendrik Willem Tydeman, een oude studievriend van haar vader. Via Van Lennep en Tydeman sleet ze bijdragen aan onder meer <cite>Het Leeskabinet</cite>, tijdschrift met ‘mengelwerk tot gezellig onderhoud voor beschaafde kringen’, en de <cite>Holland Almanak</cite>.
            <br>
            <img src="/images/" alt="">
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="corneliacarolinamargarethaluyken" data-writer="corneliacarolinamargarethaluyken">Erica</writer>, onder dat pseudoniem publiceerde Cornelia Carolina Margaretha Luyken (Amsterdam, 28 januari 1805 – Vianen, 6 september 1872) vanaf 1850 verhalen en gedichten. ‘Ongekunstelde uitstortingen van mijne gedachten en inzichten’ noemde ze de ‘herziene dichtstukjes’ die ze in 1854 opnam in de bundel <cite>Harptoonen</cite>. In een van de verzen, een loflied op de Franse dichter-filosoof Alphonse de Lamartine, beleed zij haar geloof in tucht, orde en wet. Vanuit datzelfde geloof had zij vier jaar eerder in <cite>Kleine verhalen en gedichtjes voor de jeugd</cite> (1850) een gedicht gepubliceerd waarin zij bij monde van ene Maurits in briefvorm een reis per stoomboot via Arnhem naar Mettray, een landbouwkolonie voor arme en verwaarloosde jongens bij Zutphen, beschreef:
        </p>
        <blockquote>
...
Naar Mettray heen gereden.
    ...
    <section>
        <p>
            <img src="/images/" alt="Harm Boom">
            <writer name="harmboom" data-writer="harmboom">Harm Boom</writer> (Gramsbergen, 1 december 1810 – Assen, 12 juni 1885) was net een jaar redacteur van de <cite>Utrechtse Avondpost</cite>, toen hij – anoniem – het werkje <cite>Wat een Utrechtenaar zag en hoorde bij de Beurs-inwijding te Amsterdam, en vervolgens te Kampen, Zwolle, Deventer, Zutphen en Arnhem</cite> (1846) publiceerde. Het reizen zat hem dus al in het bloed voor hij een van ‘de drie Podagristen’ werd (de andere twee waren Dubbeld Hemsing van der Scheer en Alexander Lodewijk Lesturgeon) die met hun tweedelige reisboek <cite>Drenthe in vlugtige en losse streken geschetst, door Drie Podagristen</cite> (1842-1843) de weg bereidden voor een eigen Drentse literatuur. Boom vond: ‘Reizen is leven, als men met een opgeruimd en weetgierig hart zijne woning verlaat, om met eigen oogen de wonderen van natuur en kunst, ons aan den haard door schrift en penseel zo heerlijk voorgeschilderd, te beschouwen.’ Hij verwierf faam als een van de eerste volledig Drentstalige schrijvers van novellen en feuilletons in de <cite>Provinciale Drentsche en Asser Courant</cite>.
            <br>
            Van zijn vertellingen in de streektaal waren met name <cite>Berend Veltink oet ’t Emmer Kerspel op reize noa Grönningen um ’t peerdespul van Carré te zeen en wat hum daorbij overkwam, hen en weerum</cite> (1878) en het vervolg <cite>Jaaije Veltink, geb. Rasing, oet ’t Emmer Kerspel, op reize nao Assen om ’t leste Landhuusholdkundig Congres bij te wonen en wat heur daorbij overkwam, hen en weerumme</cite> (1880) zeer populair.
            <br>
...
Meer kunnen wij van Zutphen niet zeggen, want des nademiddags reden wij reeds in eene opene tilburij den straatweg op naar Arnhem.
    ...
    <section>
        <p>
            <img src="/images/" alt="Theodore Karel Mathieu von Baumhauer">
            <writer name="theodorekarelmathieuvonbaumhauer" data-writer="theodorekarelmathieuvonbaumhauer">Theodore Karel Mathieu von Baumhauer</writer> (Brussel, 17 november 1824 – Zutphen 24 september 1900) studeerde in Utrecht letteren, wijsbegeerte en theologie en werd hervormd predikant. Van 1854 tot zijn emeritaat in 1891 stond hij in Zutphen op de kansel. Dat hij hier een vermelding verdient, dankt hij niet aan zijn artikelen en boekbeoordelingen op zijn vakgebied, maar aan het dagboek dat hij als jongen in Brussel bijhield van zijn tiende levensjaar: <cite>Dagboek van Theodore Karel Mathieu v: Baumhauer oud 10 jaar geb. te Brussel. Van den 1sten januarij tot den laatsten december van het jaar 1834</cite>. Het dagboek is nooit gepubliceerd. Het manuscript is in te zien bij het Nationaal Archief in Den Haag. Von Baumhauer woonde aan de Houtmarkt 70.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Willem Gerard Brill">
            De letterkundige <writer name="willemgerardbrill" data-writer="willemgerardbrill">W.G. (Willem Gerard) Brill</writer>, geboren in Leiden op 10 oktober 1811, was voor zijn benoeming tot hoogleraar in de Letteren in Utrecht, in 1859, negentien jaar lang docent voor de vier moderne talen plus geschiedenis aan het Stedelijk Gymnasium, waar hij onder anderen D.A.M. Binnendijk (zie verderop) als leerling had. Hij woonde aan de Markt 265. Brill was de eerste Goethe-<i>Forscher</i> in Nederland; zijn eerste artikel over Goethe in het letterkundige tijdschrift <cite>De Gids</cite> dateert van 1838. Brill overleed in Utrecht op 29 januari 1896.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Mathijs Jacobus Koenen">
            De bekende woordenboekenmaker <writer name="mathijsjacobuskoenen" data-writer="mathijsjacobuskoenen">Mathijs Jacobus Koenen</writer> (Zutphen, 11 oktober 1847 – Maastricht, 1 augustus 1920), van de Koenen-Endepols, wil ik hier kort noemen, omdat hij de vader is van de katholieke romanschrijfster, toneelschrijfster en dichteres Marie Koenen, wier roman <cite>De moeder</cite> (1917) bij bezoekers van tweedehands boekenmarkten misschien nog een belletje doet rinkelen, maar die voor het overige allang door de vergetelheid is opgeslokt. Toch zagen haar verzamelde werken ooit in veertien delen het licht. Koenen werd geboren aan de Oudewand 47.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Hendrik Carel Michaëlis">
            Dr. <writer name="hendrikcarelmichaelis" data-writer="hendrikcarelmichaelis">H.C. (Hendrik Carel) Michaëlis</writer> (Amsterdam, 10 maart 1818 – Arnhem, 21 juni 1896), van 1852 tot 1887 praeceptor in de oude talen en wiskunde en vervolgens conrector aan het gymnasium, was medewerker van de <cite>Vaderlandsche Letteroefeningen</cite>, de <cite>Nederlandsche Spectator</cite> en andere tijdschriften. Hij vertaalde <cite>Reis van den Mississippi naar de kusten van den Grooten-Oceaan</cite>, door Balduin Möllhausen (1858, een uitgave van A.E.C. van Someren) en is de schrijver van <cite>Over het innig verband tusschen volksbeschaving en nationale dichtkunst, blijkbaar uit de dichtkunst der Grieken</cite> (1850). Michaëlis woonde aan de Waterstraat C114.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Ferdinand Hugo Benjamin von Hoff">
            Intrigerend is de figuur van <writer name="ferdinandhugobenjaminvonhoff" data-writer="ferdinandhugobenjaminvonhoff">Ferdinand Hugo Benjamin von Hoff</writer>. Geboren 24 april 1820 in Harderwijk, kwam hij na zijn letterenstudie en een aanstelling als praeceptor aan de Latijnse school in Amsterdam naar Zutphen, waar hij tot zijn pensionering in 1890 dezelfde functie bekleedde. Hij woonde op verschillende adressen: Waterstraat C131, Markt 274, Markt 378, Nieuwstad A21. Onder het pseudoniem Phantastikos schreef hij in 1871 in Zutphen de satire <cite>Nephelokokkygia, de wolkenhemel der vogelen, Aristophanes’ komedie gespeeld op het hedendaagsch wereldtooneel. Een nevelbeeld waargenomen door den grooten dwarskijker en afgeschetst met het puntig staal van Phantastikos. Met ophelderende kantteekeningen</cite>. Von Hoff karakteriseerde dit curieuze werk als een ‘mengsel van ’t ware in ’t onware en ’t onware in ’t ware’ en hij had er ‘den zoekers der waarheid’ en ‘bestrijders van ijdelheid en schijn’ mee op het oog.
            <br>
            <cite>Nephelokokkygia</cite> vertelt het verhaal van de vrienden Mallepraat en Morniet die, op zoek naar het ideale land – dat wil zeggen, waar zij zelf de baas kunnen zijn –, naar de vogelmarkt gaan voor advies. De een koopt een kraai, het meest van alle vogels ervaren in de kunst van het waarzeggen; de ander koopt een uil, bekend zoals men weet om zijn wijsheid. De kraai en de uil hebben veel van de wereld gezien, maar het ideale land kennen ze niet. Ze raden de vrienden daarom aan de hoge berg te beklimmen waar de adelaar huist; die zal het, met al zijn geografische kennis, vast wel weten. Wat volgt is een poging van Mallepraat en Morniet om, als aanvoerders van het verzamelde vogelvolk, een heilstaat te stichten, die uiteraard uitmondt in een nachtmerrie. Von Hoff overleed op 29 december 1894 in Den Haag.
        </p>
    </section>

    <section>
        <p>
            Jonkheer <writer name="willemgeorgehendrikderivercourt" data-writer="willemgeorgehendrikderivercourt">W.G.H. (Willem George Hendrik) de Rivecourt</writer>, wiens leven van 20 april 1794 tot 31 oktober 1874, ofwel van geboorte tot dood, aan Zutphen verbonden is, was kapitein bij het leger en een verwoed portrettenverzamelaar. Na zijn pensionering besloot hij samen met de Borculose dominee J.C. Kobus, die eveneens een grote verzameling portretten bezat, tot het schrijven van de bij deze portretten behorende levensbeschrijvingen. Dit leidde tot een <cite>Biographisch woordenboek van Nederland, bevattende de levensbeschrijvingen van personen, die zich in Nederland op het gebied van de kunst, wetenschap en letteren; uitvindingen, ontdekkingen en belangrijke daden hebben bekend gemaakt</cite>. Het verscheen van 1854-1861 in drie delen bij de Zutphense uitgever Van Someren en was van grote waarde bij het samenstellen van dit gidsje. De Rivecourt woonde aan de Rodetorenstraat C210 (nu Lange Hofstraat 29).
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Johannes Hendrikus van Linschoten">
            <writer name="johanneshendrikusvanlinschoten" data-writer="johanneshendrikusvanlinschoten">J.H. (Johannes Hendrikus) van Linschoten</writer>, geboren 8 april 1838 in Utrecht, werd in 1863 hoofdonderwijzer aan de ‘Christelijke school voor lager en meer uitgebreid onderwijs’. Hij woonde aan de Broederenkerkstraat B149 en de Oudewand E62. Hij was redacteur van <cite>Timotheus, tijdschrift voor de jeugd</cite> en schreef historische verhalen en romans zoals <cite>De Markies van Rovalet</cite> (1866), <cite>Pitcairn, of de muiters uit de Zuidzee</cite> (1868) en <cite>Kluchtige ijsavonturen van Wipneus</cite> (1880). Verschillende van zijn boeken werden uitgegeven in Zutphen. In 1871 verhuisde Van Linschoten naar Middelburg, waar nog datzelfde jaar op 13 december zijn echtgenote Sophia Elisabeth Kuhlemeier overleed. Daarna ontbreekt elk spoor van Van Linschoten, behalve dan dat er tot in de jaren 1920 nog werk van zijn hand verscheen: <cite>Mathilde, of de dochter van een kermis-komediant : uit het leven</cite> (4e druk in 1920); <cite>De sluipmoordenaar van Villefans : een historisch schets</cite> (3e druk in 1922).
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Johann Wilhelmus Theodoor Lublink Weddik">
            <writer name="johannwilhelmustheodoor" data-writer="johannwilhelmustheodoor">J.W.Th. (Johann Wilhelmus Theodoor) Lublink Weddik</writer>, geboren 25 november 1830 in Purmerend, was van 1858 tot 1861 predikant van de Evangelisch-Lutherse gemeente in Zutphen. Hij woonde aan de Nieuwstad A128. Zoals te doen gebruikelijk in de eeuw van de dominee-dichters schreef hij naast godgeleerde verhandelingen ook gedichten. Bundel: <cite>Daphé</cite>. Hij overleed op 5 augustus 1910 in Wiesbaden.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Johan Hendrik Gallee">
            <writer name="johanhendrikgallee" data-writer="johanhendrikgallee">J.H. (Johan Hendrik) Gallee</writer> (Vorden, 9 september 1847 – Utrecht, 3 februari 1908) bezocht van 1860 tot 1866 het gymnasium in Zutphen en werd in 1876 de eerste hoogleraar in de Germanistiek en het Sanskriet in Utrecht. Hij maakte niet alleen studie van dialecten, als student schreef hij in het Achterhoeks ook <cite>Twee präotjes van ’t volk</cite> (1870): ‘De bebbenbek’ (De vrouwengek) en ‘Het verhaal van schèle Guurte’. Uit dat laatste verhaal:
        </p>
        <blockquote>
...
Now was ze deruut; met Sinte Peter gink ze trouwen met Gartjan, want de goldsmid in Zutphen had zoovölle geld veur de luchte egèven, dat ze der een plaatse veur kost koopen onder Hacfort, dicht bij ’t Smallegoor.
    ...
    <section>
        <p>
            –<writer name="michielvandersloten" data-writer="michielvandersloten">M. (Michiel) van der Slooten</writer>, geboren 23 mei 1811 in Arnhem, waar hij deurwaarder was bij de arrondissementsrechtbank, overleed op 20 mei 1863 in Zutphen, waar hij verpleegd werd in het geneeskundig gesticht. Hij is de schrijver van: <cite>Hero. Geschiedkundig-romantisch verhaal uit den 80jarigen strijd tegen Spanje</cite> (1851).
        </p>
    </section>
...
Bij het uittreden uit het bad zoodra men weêr in zijn koets gestapt is, werpe men zich een groot linnen laken over hoofd en lijf, of late zich dit doen, en drooge zich, vooral het hoofd, zorgvuldig af. Men vermijde dit werk zittend te verrigten, maar staat daarbij zoo veel mogelijk regt op. Daarna opene men de deur of een venster van de badkoets, naar de zijde waar men geen wind heeft; men kleede zich schielijk aan, en houde zich, na het bad, ten minste een half uur in de vrije lucht op. Het is zeer nadeelig, de neiging tot rusten, die korter of langer na het baden bespeurd wordt, toe te geven en te slapen.
    ...
    <section>
        <p>
            <img src="/images/" alt="George Lodewijk Kepper">
            De Amsterdammer <writer name="georgelodewijkkepper" data-writer="georgelodewijkkepper">G.L. (George Lodewijk) Kepper</writer>, geboren op 28 november 1842, kent Zutphen slechts als passant: hij was er als militair ‘in bezetting’. Als schrijver maakte hij naam met de tweedelige roman <cite>Een ongeluksvogel</cite> (1866), <cite>In- en uitvallen</cite> (1867) en <cite>Waarom hij de eenzaamheid zocht</cite> (1868). Pas na deze drie romans durfde hij het aan onder zijn volledige naam te publiceren; daarvoor had hij zich enkel van zijn eerste voornaam bediend. Behalve oorspronkelijk werk leverde Kepper ook vertalingen, zoals <cite>Sensatie-romans. Litterarische parodiën naar den beroemden Amerikaanschen humorist Bret Harte</cite> (1872). Na zijn militaire loopbaan werd hij hoofdredacteur van het <cite>Utrechtsch Dagblad</cite> en redacteur van het <cite>’t Humoritisch Album</cite>. Kepper overleed op 12 februari 1919 in Den Haag.
        </p>
        <blockquote>
...
(G.L. Kepper, uit ‘Zonder getuigen’, uit: Licht en schaduw, novellen en schetsen, 1881)
    ...
    <section>
        <p>
            ...
            <br>
            Werndly werd op 1 januari 1830 geboren in Deventer. Als letterenstudent in Utrecht droeg hij onder de naam Didymus maar ook wel anoniem verhalen en gedichten bij aan studentenalmanakken en jaarboekjes als <cite>Aurora, Vergeet mij niet, Onze Muze, Holland , Noord en Zuid (Academische Mengelingen), Jaarboekje voor Rederijkers en de Almanak voor Hollandsche Blijgeestigen</cite>. Verder publiceerde Werndly, die Nederlands eerste schaakkampioen was, schaakgedichten in <cite>Sissa</cite>, het blad van schaakgenootschap ‘Strijdt met Beleid’, en schreef hij <cite>Voor vriend en vreemde. Een herinneringsblad aan den schaakwedstrijd gehouden te Nijmegen</cite> (1858). Werndly verkeerde in de gezegende omstandigheid dat hij niet hoefde te werken voor zijn geld en zich dus volop kon uitleven in zijn liefhebberijen. Behalve schaken en schrijven – hij is ook nog de auteur van <cite>De markies van Posa, treurspel in vier bedrijven</cite> (1862) – was dat schilderen en tekenen, al zijn er geen schilderijen en tekeningen van hem bekend.
            <br>
...
Van dat Natuur aan hem het eerst het aanzijn gaf,
    ...
    <section>
        <p>
            <img src="/images/" alt="Johannes Godefridus Frederiks">
            De letterkundige <writer name="johannesgodefridusfrederiks" data-writer="johannesgodefridusfrederiks">J.G. (Johannes Godefridus) Frederiks</writer>, geboren 24 april 1828 op Duinvliet, onder Oostkapelle, was van 1872-1880 leraar Nederlands en geschiedenis aan de HBS in Zutphen. Daarna verhuisde naar Amsterdam, waar hij op 5 mei 1896 overleed. Frederiks leverde bijdragen aan tal van literaire tijdschriften zoals <cite>Vaderlandsche Letteroefeningen</cite> (in de wandelgangen ook wel: <i>Leuteroefeningen</i>), <cite>De Gids, De Nederlandsche Spectator en de Dietsche Warande</cite>. In 1876 publiceerde hij <cite>De intocht van Karel den Stoute te Zutphen in 1473</cite>. Samen met F.Jos. van den Branden schreef hij het <cite>Biographisch Woordenboek der Noord- en Zuid-Nederlandsche Letterkunde</cite> (1891), waarvan voor dit overzicht veelvuldig en dankbaar gebruik is gemaakt. Dit woordenboek had in 1878 al een eerdere editie gekend, die was samengesteld door voornoemde Van den Branden en Wilhelmus Jacobus Arnoldus de Witt Huberts. Frederiks woonde Pelikaanstraat C296-2 (nu Houtmarkt 80-82).
        </p>
    </section>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            <writer name="wilhelmusjacobusarnoldusdewitthuberts" data-writer="wilhelmusjacobusarnoldusdewitthuberts">Wilhelmus Jacobus Arnoldus de Witt Huberts</writer>, geboren in Harderwijk op 27 maart 1829, werd in 1858 aardrijkskunde- en geschiedenisleraar aan het Stedelijk Gymnasium en in 1860 gemeentebibliothecaris en archivaris. In die functie schreef hij <cite>De geschiedenis der Oude Zutfensche Latijnsche School</cite> (1863). Verder maakte hij vertalingen van o.m. Jules Verne en publiceerde hij talloze novellen en schetsen in tijdschriften, dagbladen en almanakken, en – anoniem – een blijspel getiteld <cite>De vingerhoed</cite> (1865). Huberts woonde in de Kuiperstraat C74. Hij overleed op 4 juni 1909 in Amsterdam.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Emile (Anton Hubert) Seipgens">
            <writer name="emileantonhubertseipgens" data-writer="emileantonhubertseipgens">Emile (Anton Hubert) Seipgens</writer>, geboren 16 augustus 1837 in Roermond, was van 1876 tot 1883 leraar Duits aan de Rijks HBS in Zutphen. Hij richtte er een literair leesgezelschap voor zijn leerlingen op en werd lid van de ‘Kring voor wetenschappelijk onderhoud’. Hij woonde Nieuwstad A128-2 (nu Diezerstraat 31-32). Seipgens was een uitgesproken Limburgs auteur. Zijn werk – toneel, romans en dorpsnovellen – is steevast in Limburg gesitueerd, en soms – zijn liedjes – zelfs in Limburgs dialect geschreven. Enkele van zijn bekendste en meest gelezen titels schreef hij in zijn Zutphense periode: <cite>De kapelaan van Bardelo</cite> (1880), <cite>Uit Limburg. Novellen en Schetsen</cite> (1881). In deze periode maakte Seipgens, die eerst voor priester was opgeleid, toen bierbrouwer was, vervolgens leraar, om uiteindelijk schrijver te worden, zich definitief los van de katholieke kerk. Hij begon aan de lopende band verhalen te schrijven, die hij publiceerde in bladen als <cite>De Gids, Nederland en Elsevier</cite>. Een van die verhalen, <cite>Rooien Hannes</cite>, had bewerkt tot volksdrama en opgevoerd door het Nederlandsch Tooneel groot succes. Latere titels zijn: <cite>In en om het kleine stadje</cite> (1887), <cite>Langs Maas en Geul</cite> (1890), <cite>De moordenaarster</cite> (1892), <cite>Jean, ’t Stumpke, Hawioe-Ho</cite> (1893), <cite>De Zûpers van Bliënbèèk</cite> (1894) en <cite>Een Wilde Rozenkrans</cite> (1894). In 1892 werd Seipgens secretaris van de Maatschappij der Nederlandse Letterkunde in Leiden, en in die plaats overleed hij op 25 juni 1896. Postuum verscheen nog zijn roman <cite>Daniel</cite> (1897) en de bundel <cite>Een Immortellenkrans</cite> (1897). Seipgens, die geldt als een van de vroegste naturalisten van Nederland, raakte volkomen in de vergetelheid, tot er eind jaren ’70 van de vorige eeuw zowaar een kleine revival ontstond. Die leidde onder meer tot herdrukken van de novelle <cite>De kapelaan van Bardelo</cite> en de verhalenbundel <cite>In en om het kleine stadje</cite>, alsmede tot de publicatie van zijn biografie, geschreven door Peter Nissen: <cite>Emile Anton Hubert Seipgens</cite> (1837-1896). <cite>Van brouwerszoon tot letterkundige</cite> (1987), en het plaatsen van een gedenksteen aan Seipgens geboortehuis. Maar deze opleving was van korte duur. Als Emile Seipgens in de herinnering voortleeft, zal het zijn om zijn op de legende van de rovershoofdman Johann Bückler gebaseerde ‘operabouffe’ <cite>Schinderhannes</cite> (1864), die tot op de dag van vandaag in Roermond wordt opgevoerd! Hieruit het volgende lied:
        </p>
        <pre>
...
Maar wat kan u ook de buitenwereld schelen, d. i. dat beetje wat er overschiet als men Harfsen van de wereld aftrekt? — Ik geloof dat hier de armen van geest wonen, die het eenmaal zoo goed zal gaan. Ik zet het u trouwens in drieën, lieve Harfsenaren, om in uw woestenij te zondigen. Leent nooit het oor aan het gepraat van omwonende volken, als daar zijn die van Laren en van Almen en die van Gorssel, en als gij niet eenmaal verschrompelt in uwe ijzingwekkende woonplaats, eet dan blij ten eeuwigen dage uw morgenpannekoeken, uw middagpannekoeken en uw avondpannekoeken, besproeid met saus van karnemelk, olie en spek. En als gij ’s winters avonds bij den haard nog eens keuvelt over den zomer van het jaar 1876, toen het Hollandsche leger bij u te gast was, denkt dan dat ik altijd nog met dankbaarheid de gulle ontvangst gedenk door u, die speciaal gedroogde appels haaldet uit Zutfen bij eene temperatuur van 92° Fahrenheit.
        ...
        <p>
            Beekmans historisch-geografische publicatie <cite>Nederland als polderland</cite> (1884) veroorzaakte ‘een omwenteling’ in het aardrijkskundeonderwijs. Ook verzorgde hij een <cite>Schoolatlas van Nederland</cite> (1889). Beekman was 28 jaar bestuurslid van het Koninklijk Nederlandsch Aardrijkskundig Genootschap en 37 jaar redacteur van het tijdschrift van dit genootschap. Hij woonde aan het Stationsplein B332. In 1891 verliet hij Zutphen om directeur te worden van de HBS in Schiedam. Hij overleed op 23 mei 1947 in Den Haag.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Hendrik Willem Heuvel">
            Heel nauw was de band van <writer name="hendrikwillemheuvel" data-writer="hendrikwillemheuvel">Hendrik Willem Heuvel</writer> met Zutphen niet en heel innig zal hij evenmin zijn geweest. Als jong kwekeling werd Heuvel, om zijn eerste ervaring in het lesgeven op te doen, in mei 1881 aangesteld op de Normaalschool in Zutphen. Vanuit zijn woonplaats, de buurtschap Oolde bij Laren, waar hij 5 augustus 1864 op boerderij Blauwhand geboren, betekende dat iedere zaterdag drie uur heen lopen en idem terug. Toen de frequentie in september werd opgevoerd naar vier maal per week, was dat voor Heuvel niet meer op te brengen. Hij werd onderwijzer bij de legendarische meester Postel in Laren en maakte een glanzende carrière in het onderwijs als schoolhoofd, eerst in Gelselaar, daarna in Borculo, waar hij 10 mei 1926 overleed. Heuvel schreef uitvoerig over de historie van de noordelijke Achterhoek. In het postuum gepubliceerde <cite>Oud Achterhoeksch boerenleven</cite> (1927) beschrijft hij zijn jeugd op het platteland. Na zijn dood werd de meester H. W. Heuvelstichting opgericht met het de nagedachtenis van Hendrik Willem Heuvel te eren. Heuvels archief wordt bewaard in het Streekarchief in Doetinchem.
        </p>
    </section>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            De Overijsselse dialectdichter <writer name="hermanberghege" data-writer="hermanberghege">Herman Berghege</writer>, op 5 februari 1864 geboren in Haaksbergen, zat in Zutphen op het gymnasium. Berghege, in het dagelijks leven onder meer werkzaam bij de belastingsdienst en als administrateur bij een ziekenfonds, begon met publiceren rond de eeuwwisseling toen hij in Almelo woonde. In 1903 verscheen zijn belangrijkste werk, de geheel in het Twents geschreven dichtbundel <cite>Uit het land van den Tubant</cite>. Het duurde tot 1935 eer er een tweede bundel verscheen: <cite>Oet Hoksebarge</cite>. Berghege overleed op 26 maart 1937 in Deventer. In 1983 verscheen een keuze uit zijn werk onder de titel <cite>Oet Hoksebarge. Bloemlezing uit de gedichten van de Haaksbergse dichter Herman Berghege</cite>. Zes van Bergheges gedichten werden op muziek gezet en in 1930 uitgegeven onder de titel <cite>Twenthe zingt</cite>.
        </p>
    </section>

    <section>
        <p>
            –<writer name="antonyadriaanvanotterloo" data-writer="antonyadriaanvanotterloo">A.A. (Antony Adriaan) van Otterloo</writer> (Amsterdam 29 april 1847), werd in 1883 predikant bij de Nederlands Hervormde gemeente. Hij woonde aan de Coehoornsingel 80. ‘Meer door het gesproken dan door het geschreven woord liet hij zijn licht schijnen.’ Wij noemen hem hier vanwege zijn proefschrift over Ruusbroec: <cite>Johannes Ruyschbroeck. Bijdrage tot de kennis van den ontwikkelingsgang der Mystiek</cite> (1874). Hij overleed op 6 augustus 1895 en werd begraven op de oude begraafplaats aan de Warnsveldseweg.
        </p>
    </section>

    <section>
        <p>
            <img src="/images/" alt="Aegidius Willem Timmerman">
            <writer name="aegidiuswillemtimmerman" data-writer="aegidiuswillemtimmerman">Aeg. W. (Aegidius Willem) Timmerman</writer>, geboren 23 augustus 1858 in Amsterdam, werd in 1887 leraar oude talen aan het Stedelijk Gymnasium, een functie die hij vijf jaar vervulde. Hij woonde aan de Oudewand 20. Timmerman was bevriend met Herman Gorter, Willem Kloos, Jacques Perk en vele andere Tachtigers. Hij schreef gedichten, essays en een roman, <cite>Leo en Gerda</cite> (1911). Het bekendst werd hij echter om zijn vertalingen van Homerus, Lucretius en Vergilius, en om zijn sappige en met sprankelend plezier vertelde memoires, <cite>Tim’s herinneringen</cite> (1938, in 1983 herdrukt in de reeks ‘Privé-domein’), die zijn eerste dertig levensjaren beslaan. Het boek besluit met het uiteenvallen van de vriendenband met ‘de kunstenaars van naam, waarmede ik sinds het begin van mijn studententijd heb omgegaan’, omdat voor ieder van hen een rol in het maatschappelijk leven wacht. ‘Een geregelde omgang verdween toen velen onzer het Amsterdamsche centrum verlieten, Diepenbrock naar Den Bosch, Gorter naar Amersfoort en ik zelf eerst naar Heidelberg, daarna naar Almeloo, waar – mislukte! – pogingen werden gedaan om een soort Progymnasium op te richten, en later naar Zutfen vertrok.’
            <br>
...
Overigens is de taak, den klassieken leeraren opgelegd, belachelijk zwaar. Wie kan eischen, dat iemand eenigermate thuis is in minstens veertien Grieksche en Latijnsche schrijvers, waar een heel leven ontoereikend is om Homerus-alléén te leeren begrijpen.
    ...
    <section>
        <p>
            <img src="/images/" alt="(Eliza) Johan de Meester">
            In 1877 kwam de nog piepjonge <writer name="elizajohandemeester" data-writer="elizajohandemeester">(Eliza) Johan de Meester</writer> (Harderwijk 6 februari 1860 – Utrecht 16 mei 1931) naar Zutphen, waar hij na een kort verblijf op een registratiekantoor als journalist werd aangenomen bij de <cite>Zutphensche Courant</cite>. Wat hij in Zutphen uitspookte is te lezen in het ‘Levensbericht’ dat de Maatschappij der Nederlandse Letterkunde bij zijn verscheiden publiceerde: ‘In zijn vrijen tijd bezocht hij de catechisatie van ds Talma […]. Edoch, de lezing van Rousseau. Schopenhauer, Byron, Leopardi, Zola en onzen Multatuli hadden zijn geest reeds zoodanig ontwikkeld, dat hij formeele debatten met den dominee voerde, hetgeen ten gevolge had, dat deze tenslotte verklaarde: “Neen je kunt geen lidmaat worden.”’
            <br>
            De Meester las niet alleen, hij begon ook zelf te schrijven. Na vijf jaar lag er een bundel korte verhalen, getiteld <cite>Kleingoed; Schetsjes en Silhouetten</cite> (Zutphen 1882, een uitgave van Thieme). Het jaar daarop verruilde hij de <cite>Zutphensche Courant</cite> voor Het <cite>Rotterdamsch Nieuwsblad</cite> en <cite>De Amsterdammer</cite> en Zutphen voor Amsterdam, waar hij werd opgenomen in de ‘toenmalige jonge schrijversbent’ van Frederik van Eeden, Lodewijk van Deyssel, Albert Verwey en de andere Tachtigers. De Meester schreef over beeldende kunst, toneel en literatuur en ontwikkelde zich tot een vooraanstaande figuur. Hij werd redacteur ‘voor letteren en kunst’ van de <cite>NRC</cite> en redacteur van het eerbiedwaardige tijdschrift <cite>De Gids</cite>. Daarnaast schreef hij gewaardeerde, naturalistisch getoonzette romans als <cite>Geertje</cite> (1906), <cite>De zonde in het deftige dorp</cite> (1912) en <cite>Het avontuur van David Zangvogel</cite> (1925).
            <br>
            In de roman <cite>Carmen</cite> duikt Zutphen even op:
        </p>
        <blockquote>
...
Dat dit nu hier te Zutphen gebeurd was! Tilly moest het wel gelooven. Immers bevestigden de brieven, dat Lex weer met meer dan één vriend het aanlei. En het ellendige apotheekmensch – dat ze klikte, was erg genoeg; gelogen hebben, zou ze het niet.
    ...
    <section>
        <p>
            <writer name="jabientjes" data-writer="jabientjes">J.A. Bientjes</writer>, geboren 26 april 1848 in Hellevoetsluis, was iemand die aan één carrière niet genoeg had. Zo was hij onder meer kinderboekenschrijver, onderwijsvernieuwer, gevangenisdirecteur en ‘ontdekker’ van de badplaats Noordwijk.
            <br>
            Bientjes begon als leraar wiskunde en boekhouden in Arnhem, daarna op de HBS voor Meisjes in Amsterdam en ten slotte, in 1880, op de HBS in Utrecht. In 1883 publiceerde hij een opstel over de wenselijkheid van ‘vacantie-koloniën’ met hun ‘frissche lucht’ en mogelijkheden voor sport en spel liet hij zich eervol ontslaan bij de HBS, om directeur te worden van de ‘Maatschappij Noordwijk tot exploitatie van duingronden’. <cite>Het Vaderland</cite>: ‘Hij was het, die het eerst voor het maken van een badplaats aldaar voelde, den burgemeester daarvoor warm maakte, grondslag legde voor het Huis ter Duyn en op de noodzakelijkheid van tramverbinding wees.’
            <br>
            In 1887 verdween Bientjes uit Noordwijk en dook hij op in Zutphen als hoofdredacteur van de <cite>Zutphensche Courant</cite>. In deze functie hield hij het lang vol. Hij woonde aan de IJsselkade 27, bemoeide zich behalve met de krant actief met het culturele leven in Zutphen en omstreken – zo zamelde hij geld in voor een nieuwe grafzerk op de laatste rustplaats van de in Steenderen begraven schrijver van historische romans als <cite>Het slot Loevestein</cite> en <cite>De schaapherder</cite> J.F. Oltmans – en vertaalde en bewerkte kinderboeken met titels als <cite>Hans Sterk de olifantenjager, Bob de millionair, De schipbreukeling van De Admiraal en De strijd om het Ohio-dal</cite>.
            <br>
            In 1894 mengde Bientjes zich in een landelijk en zelfs internationaal de aandacht trekkende ontvoeringszaak rond Marie Catherine Bulkley-Bekking en haar kleinzoon met de publicatie van <cite>Eene grootmoeder : een waar levensbeeld / geschetst door J.A. Bientjes</cite>. De grootmoeder in kwestie zat na haar veroordeling in Zutphen in de gevangenis, dus Bientjes zat om zo te zeggen dicht op het verhaal.
            <br>
    ...
    <section>
        <p>
            <img src="/images/" alt="">
            Op zaterdag 30 mei 1896 werd op de oude begraafplaats aan de Warnsveldseweg de cultuurhistoricus en schrijver <writer name="allardpierson" data-writer="allardpierson">Allard Pierson</writer> teraardebesteld in graf 348 A. Drie dagen tevoren was hij in Almen overleden op landgoed Velhorst, waar hij in de zomer van 1894 vanuit Amsterdam heen was verhuisd om ‘heul’ te zoeken voor de nierziekte die hem kwelde. Pierson, naar wie het museum van de Universiteit van Amsterdam is vernoemd, werd op 8 april 1831 geboren in Amsterdam. Hij was hoogleraar kunstgeschiedenis en godgeleerdheid en een veelzijdig schrijver. Zijn ervaringen als predikant in Leuven beschreef hij in zijn debuut: <cite>Een pastorij in den vreemde</cite> (1857), later omgewerkt tot <cite>Intimis</cite> (1861). In 1866 volgde zijn enige roman, <cite>Adriaan de Mérival</cite>, die in gesprekken en brieven de problematiek behandelt van een jonge predikant die onder de bekoring van het modernisme is geraakt. ‘Uitweidingen en het te lang voortborduren op een bepaalde gedachte verhinderen de lezer geboeid te raken door de intrige,’ vond een criticus. En dat geloven wij graag, want het boek bestaat uit drie delen die elk driehonderd bladzijden dik zijn. Ook als dichter liet hij het bij één poging: <cite>Gedichten</cite> (1882). Veel gelezen waren zijn <cite>Oudere tijdgenooten</cite> (1888), een verzameling essays over collega-schrijvers die eerst waren verschenen in <cite>De Gids</cite>, en het vervolg: <cite>Jongere tijdgenooten</cite> (1989-90).
        </p>
    </section>
